...
APPNAME = "Tobalaba"
else ifeq ($(CHAIN),solidum)
APP_LOAD_PARAMS += --path "44'/997'"
DEFINES += CHAINID_UPCASE=\"SOLIDUM\" CHAINID_COINNAME=\"SUM\" CHAIN_KIND=CHAIN_KIND_SOLIDUM CHAIN_ID=72106
APPNAME = "Solidum"
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported CHAIN - use ethereum, ethereum_classic, expanse, poa, rsk, rsk_testnet, ubiq, wanchain, kusd, musicoin, pirl, akroma, atheios, callisto, ethersocial, ellaism, ether1, ethergem, gochain, mix, reosc, hpb, tomochain, tobalaba, solidum)
endif
endif
...
listvariants:
	@echo VARIANTS CHAIN ethereum ethereum_classic expanse poa rsk rsk_testnet ubiq wanchain kusd pirl akroma atheios callisto ethersocial ether1 gochain musicoin ethergem mix ellaism reosc hpb tomochain tobalaba solidum
